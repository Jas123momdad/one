...
<body>
    <header>
        <div class="container header-inner" role="banner">
            <div style="display:flex;align-items:center;gap:18px;">
                <button class="mobile-toggle" id="mobileToggle" aria-label="Open menu"><emp class="fas fa-bars"></emp></button>
                <a class="brand" href="#">
            ...
            <nav class="main-nav" id="mainNav" aria-label="Primary navigation">
                <ul>
                    <li><a href="#"><emp class="fas fa-home"></emp> Home</a></li>
                    <li class="has-dropdown" aria-haspopup="true">
                        <a href="#" id="catMenuBtn"><emp class="fas fa-th-large"></emp> Categories <emp class="fas fa-chevron-down" style="font-size:12px;"></emp></a>
                    </li>
                    <li><a href="#"><emp class="fas fa-fire"></emp> Trending</a></li>
                    <li><a href="#deals"><emp class="fas fa-tag"></emp> Deals</a></li>
                    <li><a href="#about"><emp class="fas fa-info-circle"></emp> About</a></li>
                </ul>
            </nav>
            ...
            <div style="display:flex;align-items:center;gap:14px;">
                <div class="search" role="search" aria-label="Product search">
                    ...
                    <button class="icon-btn" id="searchBtn" aria-label="Search"><emp class="fas fa-search"></emp></button>
                </div>

                <div class="header-actions" role="group" aria-label="Header actions">
                    <a class="icon-btn" title="Account" href="#"><emp class="far fa-user"></emp></a>
                    <a class="icon-btn" title="Wishlist" href="#"><emp class="far fa-heart"></emp></a>
                    <a class="cart" href="#" id="cartBtn" title="View cart" aria-label="Cart">
                        <emp class="fas fa-shopping-cart"></emp>
    ...
    <main>
        ...
        <section class="hero" role="img" aria-label="Hero banner">
            <div class="container">
                <h1>srav Collection — version 6</h1>
                ...
                <div>
                    <button class="btn btn-primary" id="shopNow">Shop Now <emp class="fas fa-arrow-right"></emp></button>
        ...
        <section class="section container" aria-labelledby="cat-title">
            <div class="title" id="cat-title">
                <h2 class="section-title">Shop By Design</h2>
        ...
        <div class="container" style="display:flex;flex-wrap:wrap;gap:28px;align-items:flex-start;justify-content:space-between">
            <div style="max-width:360px">
                ...
                <div style="margin-top:14px;display:flex;gap:10px">
                    <a class="icon-btn" href="#" title="Facebook"><emp class="fab fa-facebook"></emp></a>
                    <a class="icon-btn" href="#" title="Twitter"><emp class="fab fa-twitter"></emp></a>
                    <a class="icon-btn" href="#" title="Instagram"><emp class="fab fa-instagram"></emp></a>
                </div>
            </div>
    ...
    <script>
        ...
        function renderCategories() {
            ...
            CATEGORIES.forEach(cat => {
                ...
                el.innerHTML = `
                    <div class="icon"><emp class="fas ${cat.icon}"></emp></div>
                    <h4>${cat.name}</h4>
            ...
            list.forEach(p => {
                ...
                el.innerHTML = `
                    ...
                    <div class="product-footer">
                        <button class="add-btn" data-id="${p.id}"><emp class="fas fa-cart-plus"></emp> Add</button>
                        <button class="wish-btn" aria-label="Add to wishlist"><emp class="far fa-heart"></emp></button>
                    </div>
                `;
